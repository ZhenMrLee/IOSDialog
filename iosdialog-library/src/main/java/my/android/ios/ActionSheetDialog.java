...
public class ActionSheetDialog {
    ...
    private void setSheetItems() {
        ...
        for (int i = 1; i <= size; i++) {
            ...
            final OnSheetItemClickListener listener = (OnSheetItemClickListener) sheetItem
                    .itemClickListener;
    ...
    public class SheetItem {
        ...
        public SheetItem(String name, SheetItemColor color, OnSheetItemClickListener
                itemClickListener) {
            this.name = name;
            this.color = color;
